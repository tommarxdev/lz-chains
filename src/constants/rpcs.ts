...
export const RPCS: { [chainId in ChainId]?: string[] } = {
    ...
    [ChainId.ZKPOLYGON_TESTNET]: ["https://rpc.public.zkevm-test.net"],
    [ChainId.KLAYTN]: [
      "https://1rpc.io/klay",
    ...
    [ChainId.GNOSIS]: [
      ...
      [ChainId.ZKATANA_TESTNET]: ["https://rpc.startale.com/zkatana", "https://rpc.zkatana.gelato.digital", "https://astar-zkatana-rpc.dwellir.com"
    ], 
}